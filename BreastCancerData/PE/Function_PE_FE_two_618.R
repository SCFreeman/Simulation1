# Fit piecewise model in OpenBUGS - two cut points at 6 and 18 months

piecewise_two_cut_try_618 <- function(data, num.sims, burn.in, cutpoint1, cutpoint2){
  ...
  bugs.object<-try(R2OpenBUGS::bugs(data=ma_data, inits=inits, 
                                    ...
                                    bugs.seed=3, 
                                    working.directory="/alice-home/2/s/scf20/Documents/Example_HPC/PE_cut6_18", 
