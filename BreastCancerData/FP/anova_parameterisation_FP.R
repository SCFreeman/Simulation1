# Use Roche code to run fractional polynomial NMA
...
setwd("C:/Users/scf20/OneDrive - University of Leicester/NIHR Fellowship/Work Package 2/Example/Fractional_Polynomial")
...
fit.KM.NMA<-function(bf){
  ...
  #model formula
  f=cbind(nevents,natrisk-nevents)~treatnumf+trialid+treatnumf*beta1+treatnumf*beta2+trialid*beta1+trialid*beta2
...
#### Not run below this line 01/02/2024
