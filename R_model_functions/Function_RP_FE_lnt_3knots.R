...
royston_parmar_fe_lnt_3knots <- function(df, num.sims, burn.in){
  ...
  if(class(bugs.object)=="try-error"){
    ...
    rp_results <- data.frame(i=data$i[1], dgm=data$dgm[1], knots=3,
