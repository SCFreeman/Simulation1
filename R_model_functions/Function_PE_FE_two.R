...
piecewise_two_cut_try <- function(data, num.sims, burn.in, cutpoint1, cutpoint2){
  ...
  # N=rows of data, ints=no. of time intervals, J=no. of studies, ntrt=no. of trts
  ...
  bugs.object<-try(R2OpenBUGS::bugs(data=ma_data, inits=inits, 
                                    ...
                                    bugs.seed=3, 
                                    working.directory="/alice-home/2/s/scf20/Documents/Simulation/Scenario1/PE_two", 
                                    debug=F))
